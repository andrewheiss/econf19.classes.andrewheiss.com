...
- [<i class="fas fa-file-excel"></i> `problem-set-3.xlsx`](/files/problem-set-3.xlsx)

CORE provides step-by-step instructions for how to do this all in Excel.^[If you're feeling *super* adventurous, you can follow the instructions in R, but don't worry about that.] Make sure you click on the + sign in the green "Excel Walk-Through" sections to see these instructions:

![](/images/assignments/excel_walkthrough.png)
...
***Importantly***, [CORE provides the answers for you](https://www.core-econ.org/doing-economics/book/text/03-04.html) (\\(•◡•)/) so you can check your own findings. The important part of this assignment is figuring out the process for making PivotTables + understanding the intuition behind DiD as a method of analyzing the effectiveness of a policy. 

It'll be really tempting to copy/paste their answers into your assignment. Don't do that—answer the questions in your own words.
...
# Statistical significance crash course
