...
[Download the slides from today's class](/slides/PMAP-8141_2019-10-10.pdf).

<figure>
[![First slide](/images/slides/slides_2019-10-10.png)](/slides/PMAP-8141_2019-10-10.pdf)
</figure>
...
milk_costs %>%
  mutate(Quantity = dollar(Quantity)) %>% 
