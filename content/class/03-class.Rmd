...
[Download the slides from today's class](/slides/PMAP-8141_2019-09-12.pdf).

<figure>
[![First slide](/images/slides/slides_2019-09-12.png)](/slides/PMAP-8141_2019-09-12.pdf)
</figure>
...
results <- tribble(
  ...
  "Raising government revenue", "Progressive tax", 10, 13,
  "Raising government revenue", "Flat tax", 3, 0,
  "Unemployment assistance", "Modest assistance", 7, 5,
  "Unemployment assistance", "Generous assistance", 6, 8,
  "Immigrant workers", "Guest worker law", 10, 11,
  "Immigrant workers", "Stronger immigration law", 3, 2,
  "Health insurance", "Private insurance", 4, 2,
  "Health insurance", "National insurance", 9, 11
) %>%
